...
const CURATED_VOICE_NAMES = new Set([
  // Apple (macOS/iOS) "Default"-tier English voices confirmed to sound
  // good; several other same-tier voices (Aaron, Fred, Nicky, Arthur,
  // Martha, Catherine, Gordon, Moira, Tessa, Rishi) are technically the
  // same quality tier but sound noticeably more robotic in practice.
  "Samantha", // en-US
  "Daniel", // en-GB
  "Karen", // en-AU
